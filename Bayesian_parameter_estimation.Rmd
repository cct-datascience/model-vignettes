...
if(dir.exists("outputs/Bayesian_parameter_estimation/plots") == F){
  dir.create("outputs/Bayesian_parameter_estimation/plots", recursive = T)
}
...
for(i in 1:length(preds)){
  ...
  jpeg(filename = paste0("outputs/Bayesian_parameter_estimation/plots/", ids[i], "_ObsvsPred.jpg"),
       height = 4, width = 6, units = "in", res = 600)
  print(fig_obs_pred)
  dev.off()
}
