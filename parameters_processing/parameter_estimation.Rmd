...
source("R/LRC.R")
source("R/Gs2.R")# or one of the other options
source("R/Rd.R")
```
...
fnames <- c(paste0("outputs/ACi/", list.files("outputs/ACi", pattern = "csv")),
            paste0("outputs/AQ/", list.files("outputs/AQ", pattern = "csv")), 
            paste0("outputs/stomatal/", list.files("outputs/stomatal", pattern = "csv")),
            paste0("outputs/Rd/", list.files("outputs/Rd", pattern = "csv")))
