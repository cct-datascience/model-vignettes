...
The exception is "Differences found in 1/6 variables compared", which occurs when C4_Collatz.R model has been re-run for previously existing data. Bayesian MCMC yields slightly different means of vmax. 