...
# Conduct Hotelling's multivariate t-test
fit <- hotelling.test(.~trt, data = params)
fit

# Conduct t-tests
tt <- list()
for(i in 1:6){
  m <- t.test(c(params[,(i+1)])~params$trt)
  tt[[i]] <- 
}
```
