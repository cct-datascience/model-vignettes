...
settings <- PEcAn.settings::read.settings("ED2/AK_recent_run/pecan.xml") 
...
#rsync '-a' '-q' '--delete' '/data/tests/ed2_AK_recent_100ens_sa/run' 'kristinariemer@login.ocelote.hpc.arizona.edu:/groups/dlebauer/ed2_results/pecan_remote/DATE'
...
#rsync '-az' '-q' 'kristinariemer@login.ocelote.hpc.arizona.edu:/groups/dlebauer/ed2_results/pecan_remote/DATE/out' '/data/tests/ed2_AK_recent_100ens_sa'

# Do results post-processing
for(folder in list.dirs("/data/tests/ed2_AK_recent_100ens_sa/out", recursive = FALSE)){
