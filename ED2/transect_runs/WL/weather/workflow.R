...
# Load settings --------------------------------------------------------
#edit this path
settings <- read.settings("ED2/transect_runs/WL/weather/pecan.xml")
...
driver_path_local
driver_path_hpc <- file.path("puma:", "groups/dlebauer/ed2_results/inputs/julianp/sites", basename(driver_path_local))
driver_path_hpc
