...
```{r}
settings$run$inputs$met <- file.path("/data", "input", s$met_filename)

files <- list.files(file.path("../../../../../data/input/", s$cohort_filename))

settings$run$inputs$pss <- file.path("/data", "input", files[str_detect(files, "\\.pss$")])
settings$run$inputs$css <- file.path("/data", "input", files[str_detect(files, "\\.css$")])
settings$run$inputs$site <- file.path("/data", "input", files[str_detect(files, "\\.site$")])
```
