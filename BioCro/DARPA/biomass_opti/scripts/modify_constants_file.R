...
config <- XML::xmlToList(XML::xmlParse("~/model-vignettes/BioCro/DARPA/env_comparison/inputs/ch_config.xml"))
...
XML::saveXML(config.xml, file = "~/model-vignettes/BioCro/DARPA/env_comparison/inputs/ch_config.xml", 
             indent = TRUE)
