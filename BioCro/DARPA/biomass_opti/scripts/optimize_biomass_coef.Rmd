...
opt_results <- DEoptim(fn = opfn, lower = rep(0, 19), upper = rep(1, 19), thermaltimeParms = thermaltimevals, rhizomeParms = rhizomevals, control = DEoptim.control(itermax = 20))
...
parms_results[4:6] <- parms_results[4:6]/sum(parms_results[4:6], rhizomevals[1])
parms_results[7:9] <- parms_results[7:9]/sum(parms_results[7:9], rhizomevals[1])
parms_results[10:12] <- parms_results[10:12]/sum(parms_results[10:12], rhizomevals[1])
parms_results[13:15] <- parms_results[13:15]/sum(parms_results[13:15], rhizomevals[1])
parms_results[16:19] <- parms_results[16:19]/sum(parms_results[16:19], rhizomevals[1])
