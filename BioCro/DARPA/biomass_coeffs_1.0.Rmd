...
if(!packageVersion(pkg = 'BioCro') <= 1.0){
  ...
  install.packages('biocro_versions/biocro-dev-master/', repos=NULL, type='SOURCE') 
}
```
...
load("biomass_coeffs_1.0_inputs/setaria_initial_state.RData")
load("biomass_coeffs_1.0_inputs/setaria_parameters.RData")
```
