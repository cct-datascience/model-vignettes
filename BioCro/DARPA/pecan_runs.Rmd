...
knitr::include_graphics("pecan_runs_images/1.png")
knitr::include_graphics("pecan_runs_images/2.png")
```
...
```{r, echo=FALSE, out.width="400px"}
knitr::include_graphics("pecan_runs_images/3.png")
knitr::include_graphics("pecan_runs_images/4.png")
knitr::include_graphics("pecan_runs_images/5.png")
knitr::include_graphics("pecan_runs_images/6.png")
```