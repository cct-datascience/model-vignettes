...
* BioCro config file
* weather file created for biomass partitioning in [partitioned_biomass_data.Rmd](https://github.com/az-digitalag/model-vignettes/blob/master/BioCro/DARPA/partitioned_biomass_data.md)
* biomass file from Setaria experiments in [partitioned_biomass_data.Rmd](https://github.com/az-digitalag/model-vignettes/blob/master/BioCro/DARPA/partitioned_biomass_data.md)
