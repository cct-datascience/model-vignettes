...
dir.create("/data/output/biocro_gs_testing", recursive = TRUE, showWarnings = FALSE)
```
...
lon = -90.199402, lat = 38.627003
38.27854493790886, -104.5953341613334
37.86899250000444, -109.33881449753827
```{r}
loc.coords <- data.frame(lat = c(38.625, 38.375, 37.875), 
...
estimate_biomass <- function(genotype){
  ...
  results_path <- paste0("/data/output/biocro_gs_testing/stlew_", genotype, ".csv")
