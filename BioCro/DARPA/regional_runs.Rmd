...
estimate_biomass <- function(genotype){
  ...
  results_path <- paste0("/data/output/biocro_regional_runs/stlew_", genotype, ".csv")
...
animate(trans_prop_animation, fps = 100, height = 400, width = 400)
anim_save("stlew_trans_prop.gif", animation = trans_prop_animation, 
          path = "/data/output/biocro_regional_runs/", fps = 100, height = 400, width = 400)
```
