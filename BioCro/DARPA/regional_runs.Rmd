...
```{r}
ggplot(regional_run_results, aes(x = date, y = CanopyTrans, group = latlon, color = latlon)) +
  geom_line(alpha = 0.2) +
  labs(y = "Transpiration (Mg/ha/h)") +
  theme(legend.position = "none")
```
...
transpiration_animation <- ggplot() +
  geom_polygon(data = gif_background, aes(x = long, y = lat, group = group), 
               fill = "white", color = "black") +
  geom_raster(data = regional_run_results, aes(x = lon, y = lat, fill = CanopyTrans)) +
  geom_point(data = city_coords, aes(x = lon, y = lat)) +
...
animate(transpiration_animation, fps = 100)
...
```{r}
ggplot(regional_run_results_ss, aes(x = date, y = CanopyTrans, group = latlon, color = latlon)) +
  geom_line(alpha = 0.2) +
  labs(y = "Transpiration (Mg/ha/h)") +
  theme(legend.position = "none")
```
...
transpiration_animation <- ggplot() +
  geom_polygon(data = gif_background, aes(x = long, y = lat, group = group), 
               fill = "white", color = "black") +
  geom_raster(data = regional_run_results_ss, aes(x = lon, y = lat, fill = CanopyTrans)) +
  geom_point(data = city_coords, aes(x = lon, y = lat)) +
  scale_fill_gradient2(low = "lightblue", mid = "blue", high = "navyblue", 
                       midpoint = 75, 
                       breaks = seq(0, 200, 50), 
...
animate(biomass_animation_ca, fps = 100)
...
```{r}
ggplot(regional_run_results_ca, aes(x = date, y = CanopyTrans, group = latlon, color = latlon)) +
  geom_line(alpha = 0.2) +
  labs(y = "Transpiration (Mg/ha/h)") +
  theme(legend.position = "none")
```
...
transpiration_animation <- ggplot() +
  geom_polygon(data = gif_background, aes(x = long, y = lat, group = group), 
               fill = "white", color = "black") +
  geom_raster(data = regional_run_results_ca, aes(x = lon, y = lat, fill = CanopyTrans)) +
  geom_point(data = city_coords, aes(x = lon, y = lat)) +
  scale_fill_gradient2(low = "lightblue", mid = "blue", high = "navyblue", 
                       midpoint = 75, 
                       breaks = seq(0, 200, 50), 
