...
```{r}
dir.create("regional_runs_inputs/results/high_light_ss_chiruss")
...
for(point in 1:nrow(latlon)){
  ...
  write.csv(regional_run_result_ss_daily, paste0("regional_runs_inputs/results/high_light_ss_chiruss/daily-", 
                                         latlon$lat[point], "-", latlon$lon[point], ".csv"))
...
write.csv(regional_run_results_ss, 
          "regional_runs_inputs/results/high_light_ss_chiruss_results.csv")
```

## Plot estimated biomass

```{r}
regional_run_results_ss <- read.csv("regional_runs_inputs/results/high_light_ss_chiruss_results.csv")
...
anim_save("high_light_ss_chiruss.gif", animation = biomass_animation_ss, 
          path = "regional_runs_inputs/results/", fps = 100)
```
...
ggplot() +
  ...
  coord_cartesian(xlim = c(mean(regional_run_results_ss$lon) - 10, mean(regional_run_results_ss$lon) + 10),
                  ylim = c(min(regional_run_results_ss$lat) - 5, max(regional_run_results_ss$lat) + 5))
```
