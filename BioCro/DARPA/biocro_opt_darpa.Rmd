...
* BioCro config file
* weather file created for biomass partitioning in [biocro_biomass_darpa.Rmd](https://github.com/az-digitalag/model-vignettes/blob/master/BioCro/DARPA/biocro_biomass_darpa.md)
* biomass file from Setaria experiments in [biocro_biomass_darpa.Rmd](https://github.com/az-digitalag/model-vignettes/blob/master/BioCro/DARPA/biocro_biomass_darpa.md)
