...
```{bash}
curl -X POST --data-binary @upload_params_data/phys_parameters localhost:3000/api/v1/traits.csv?key=<fOME9Ga8VMGmieLfuFD2QDgvFbWHqMUBthXEYkjz> -H "Content-Type: text/csv"
```
