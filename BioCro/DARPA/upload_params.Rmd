...
2. `local_datetime`: convert date into machine readable format
3. `treatment`: specifies record's treatment using BETYdb treatment names
4. `Vcmax`, `leaf_respiration_rate_m2`, `stomatal_slope.g1`, `stomatal_slope.BB`, `cuticular_cond`: measured values of physiological parameters specified
5. `leafT`: leaf temperature, which is required by BETYdb
...
```{r}
params <- colnames(upload_parameters_gr)[5:9]
for(param in params){
  ...
  trait_df2 <- trait_df[complete.cases(trait_df),]
